...
<head>
    ...
    <title>E Budget MO | Mayor's Office</title>
...
<body>
    <div class="row" style="height: 100%;">
        <div class="col-2 p-0">
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-warning h-100 w-100">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="track.php" class="nav-link text-white active">
                            <i class="bi bi-card-list"></i>
                            Track Document
                        </a>
                    </li>
                    <li>
                        <a href="request.php" class="nav-link text-white mx-auto">
        ...
        <div class="col p-0">
            ...
            <div class="container p-5">
                <h2 class="text-center">Mayor's Office</h2>
                ...
                <div class="container w-75">
                    <div class="row mt-5 justify-content-center text-center">
                        <div class="col bg-primary rounded w-100 p-4 text-white border border-3 border-dark">
                            <span class="fw-bold">Created a documentation No. 1231231312!</span>
                        </div>
                    </div>
                </div>
            </div>
