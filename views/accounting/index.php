    ...
    <div class="row" style="height: 100%;">
        ...
        <div class="col p-0">
            ...
            <div class="container p-5">
                ...
                <div class="row p-4 py-5 bg-light rounded mt-5 justify-content-center text-center">
                    <table class="">
                        <tbody>
                            <tr>
                                <td style="width: 75%;">
                                    <p class="bg-primary m-2 p-3 rounded"><i
                                            class="bi bi-bell-fill text-warning"></i>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, culpa?</p>
                                </td>
                                <td class="text-end">
                                    ...
                                    <button class="btn btn-success"><i class="bi bi-check-circle"></i> Accept</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
